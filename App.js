...
const [rede, setRede]             = useState("polygon")
  ...
  async function send() {
    ...
    try {
      ...
      const params = new URLSearchParams({ token, stealthAddress, ephemeralPubKey, viewTag:String(viewTag), timelocked:String(useLock), rede });
